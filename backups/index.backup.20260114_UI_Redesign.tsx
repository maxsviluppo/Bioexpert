...
const styles = `
  ...
  *, *::before, *::after {
  ...
  /* Decorative topography lines inside main frame (top right) */
  .main-frame::before {
    content: '';
    position: absolute;
    top: -50px;
  ...
  return (
    <div className="app-shell">
      ...
      <header style={{
        ...
        >
          <div style={{
            /* No background on logo circle anymore */
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center'
          }}>
            <Sprout size={window.innerWidth <= 480 ? 28 : 32} color="#2E7D32" strokeWidth={2.5} />
          </div>
          <div>
            <h1 style={{
              color: '#1B5E20',
            ...
            {/* Removed XP bar for cleaner look as per mockup */}
          </div>
        </div>
          ...
          {activeMode === 'garden' ? (
            ...
            <div style={{ height: '100%', width: '100%', position: 'relative' }}>
              {cameraError ? (
                ...
                <div className="camera-off-overlay camera-overlay-corners" style={{ background: 'transparent' }}>
                  {/* Angoli Minimali: Top-left e Bottom-right verde scuro */}
                  <div style={{ position: 'absolute', top: 20, left: 20, width: 32, height: 32, borderTop: '4px solid #1B5E20', borderLeft: '4px solid #1B5E20', borderTopLeftRadius: 16 }}></div>
                  <div style={{ position: 'absolute', bottom: 20, right: 20, width: 32, height: 32, borderBottom: '4px solid #1B5E20', borderRight: '4px solid #1B5E20', borderBottomRightRadius: 16 }}></div>

                  <div className="logo-off-center">
                    <Sprout size={90} color="#33691E" strokeWidth={1.5} />
                    <h2 style={{ color: '#1B5E20', letterSpacing: '0.05em', fontSize: '2rem' }}>BIOEXPERT</h2>
                  </div>

                  <div className="viewfinder-box" style={{
                    margin: '20px 24px',
                    padding: '24px',
                    background: '#FFF8E1', /* Beige chiaro */
                    borderRadius: 24,
                    border: 'none',
                    textAlign: 'center',
                    ...
                    {/* Flower Decor Left */}
                    <div style={{ position: 'absolute', left: -10, bottom: -10, opacity: 0.1, transform: 'rotate(-20deg)' }}>
                      <Flower2 size={80} color="#F57C00" strokeWidth={1} />
                    </div>
                    {/* Bug Decor Right (Ape) */}
                    <div style={{ position: 'absolute', right: -10, top: -10, opacity: 0.1, transform: 'rotate(20deg)' }}>
                      {/* Usiamo un'icona generica se Bug non è disponibile o simile all'ape */}
                      <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#F57C00" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M8 12a4 4 0 1 1 8 0" /><path d="M12 7V3" /><path d="M9 4.5 10.5 6" /><path d="M15 4.5 13.5 6" /><path d="M20 12h-2" /><path d="M6 12H4" /><path d="M4 16c1 .5 2 .5 2 0" /><path d="M20 16c-1 .5-2 .5-2 0" /></svg>
                    </div>

                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 12, color: '#333', fontWeight: 800, fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <Sparkles size={16} fill="#333" /> LO SAPEVI CHE?
                    </div>
                    <p style={{ margin: 0, fontSize: '0.95rem', lineHeight: 1.5, color: '#444', fontStyle: 'italic', fontWeight: 500, fontFamily: 'serif' }}>
                      "{currentTip}"
                    </p>
                  </div>
                  ...
                  <div style={{
                    ...
                    {/* Pulsante Fotocamera - Tondo Verde Scuro */}
                    <button
                    ...
                    {/* Pulsante Galleria - Tondo Verde Lime Chiaro */}
                    {!activeGame ? (
                      <button
                        ...
                        style={{
                          ...
                          border: 'none',
                          cursor: 'pointer',
                          boxShadow: '0 10px 30px rgba(174, 213, 129, 0.4)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                        }}
