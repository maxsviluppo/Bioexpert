              ...
              <>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12, color: '#2E7D32' }}>
                    <ShieldCheck size={20} />
                    <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800 }}>Stato di Salute</h3>
                  </div>
                  <div style={{
                    background: fullScreenAnalysis.healthStatus === 'sick' ? 'linear-gradient(135deg, #FFEBEE 0%, #FFCDD2 100%)' : 'linear-gradient(135deg, #E8F5E9 0%, #C8E6C9 100%)',
                    borderRadius: 16,
                    padding: '16px',
                    marginBottom: 12
                  }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                      {fullScreenAnalysis.healthStatus === 'sick' ? (
                        <AlertTriangle size={20} color="#d32f2f" />
                      ) : (
                        <CheckCircle2 size={20} color="#2E7D32" />
                      )}
                      <strong style={{ fontSize: '1rem', color: fullScreenAnalysis.healthStatus === 'sick' ? '#d32f2f' : '#2E7D32' }}>
                        {fullScreenAnalysis.healthStatus === 'sick' ? 'Pianta Malata' : 'Pianta Sana'}
                      </strong>
                    </div>
                    <p style={{ margin: 0, fontSize: '0.85rem', color: '#666', lineHeight: 1.6 }}>{fullScreenAnalysis.diagnosis}</p>
                  </div>
                  {fullScreenAnalysis.healthStatus === 'sick' && (
                    <div style={{
                      background: 'linear-gradient(135deg, #FFF8E1 0%, #FFECB3 100%)',
                      ...
                      <span><strong>Piano di cura attivo!</strong> Vai alla tab CURA per i dettagli del trattamento.</span>
                    </div>
                  )}
                </div>
                ...
                {fullScreenAnalysis.healthStatus === 'sick' ? (
                  <>
                    <div style={{ marginBottom: 20 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12, color: '#d32f2f' }}>
                        <Heart size={20} />
                        <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800 }}>Piano di Recupero Attivo</h3>
                      </div>
                      <p style={{ margin: 0, color: '#666', fontSize: '0.85rem', lineHeight: 1.6 }}>
                        La tua pianta necessita di cure specifiche. Segui questi passaggi per il recupero completo.
                      </p>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, color: '#d32f2f' }}>
                        <Droplets size={18} />
                        <strong style={{ fontSize: '0.9rem' }}>Fase 1: Irrigazione Controllata</strong>
                      </div>
                      <p style={{ margin: 0, fontSize: '0.85rem', color: '#666' }}>
                        Riduci l'irrigazione e controlla il terreno. Annaffia solo quando asciutto.
                      </p>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, color: '#E65100' }}>
                        <Sun size={18} />
                        <strong style={{ fontSize: '0.9rem' }}>Fase 2: Esposizione Ottimale</strong>
                      </div>
                      <p style={{ margin: 0, fontSize: '0.85rem', color: '#666' }}>
                        Sposta la pianta in zona con luce indiretta. Evita sole diretto nelle ore centrali.
                      </p>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, color: '#1B5E20' }}>
                        <Scissors size={18} />
                        <strong style={{ fontSize: '0.9rem' }}>Fase 3: Potatura Foglie Danneggiate</strong>
                      </div>
                      <p style={{ margin: 0, fontSize: '0.85rem', color: '#666' }}>
                        Rimuovi foglie secche o malate per favorire la crescita di nuove foglie sane.
                      </p>
                    </div>
                  </>
                ) : (
                  <div style={{ textAlign: 'center', padding: 40, color: '#999' }}>
                    <CheckCircle2 size={48} style={{ opacity: 0.3, marginBottom: 16, color: '#2E7D32' }} />
                    <h3 style={{ color: '#2E7D32', marginBottom: 8 }}>Pianta in Salute!</h3>
                    <p style={{ margin: 0, fontSize: '0.9rem' }}>Continua a seguire i consigli rapidi per mantenerla sana.</p>
                  </div>
                )}
              </div>
            )}
              ...
              setConfirmToast({
                ...
                onConfirm: async () => {
                  try {
                    ...
                    console.error('Errore rimozione pianta:', error);
                  }
                  setConfirmToast(null);
                },
                onCancel: () => setConfirmToast(null)
