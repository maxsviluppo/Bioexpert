...
function App() {
  ...
  const evaluateBeauty = async (photo: string) => {
    try {
      ...
      let prompt = 'Identifica la pianta e valuta la sua bellezza estetica da 1 a 100. Considera: colori, simmetria, salute. Restituisci JSON puro: { "score": 85, "plant_name": "Nome Pianta" }.';

      if (isWeekly && info) {
        prompt = `Questa sfida richiede specificamente: ${info.requirement}. Identifica la pianta nella foto. SE NON E' UNA ${info.requirement} (o famiglia pertinente), IL PUNTEGGIO DEVE ESSERE BASSO (sotto 20). Se corrisponde, valuta bellezza da 1 a 100. Restituisci JSON puro: { "score": 85, "plant_name": "Nome Pianta" }.`;
      }
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    ...
                    {userPlants.map((plant: any) => (
                      <div key={plant.id} onClick={() => setFullScreenAnalysis({
                        ...
                        {plant.next_check_at && new Date(plant.next_check_at).getTime() < Date.now() && (
                          <div style={{ position: 'absolute', top: 12, left: 12, zIndex: 10, background: 'var(--danger)', color: 'white', padding: '4px 8px', borderRadius: 8, fontSize: '0.65rem', fontWeight: 900, boxShadow: '0 4px 8px rgba(0,0,0,0.2)' }}>
                            NECESSARIA CURA
                          </div>
                        )}
            ...
            <div className="overlay-content">
              ...
              <div className="settings-section">
                ...
                <div className="settings-group">
                  ...
                  <div className="settings-row" onClick={() => setNotificationsEnabled(!notificationsEnabled)}>
          ...
          <div className="overlay-content" style={{ padding: 0 }}>
            ...
            <div style={{
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                <h4 style={{ margin: '0 0 8px', fontSize: '1.2rem', fontWeight: 900 }}>🏆 PREMI DELLA SETTIMANA</h4>
